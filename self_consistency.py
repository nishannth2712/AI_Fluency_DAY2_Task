"""Part D: run the same CoT prompt several times at a higher temperature
...
if __name__ == "__main__":
    banner("SELF-CONSISTENCY — RESTAURANT ASSISTANT")
    # Question 1 (bill-splitting) is a good pick: multi-step enough to wobble.
